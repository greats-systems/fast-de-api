...
export class ParcelsService {
  ...
  async acceptReject(acceptRejectParcelDto: AcceptRejectParcelDto){
    ...
    if(acceptRejectParcelDto.driverDecision === 'accept'){
      ...
      let newOrder  = {
        packageID: acceptRejectParcelDto.packageID,
        orderDriverID: acceptingDriver.userId,
        orderOwnerID: parcelOwner.userId,
        orderType: parcel.packageType,
        orderPickupTime: '',
        orderDriverDepartingCoordinates: '',
        driverDepartingPickupDistance: '',
        orderPickupCoordinates: '',
        orderDeliveryCoordinates: '',
        orderRouteDistance: '',
        DeliveryStatus: '',
        orderAmount: '',
      }
