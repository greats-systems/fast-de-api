...
export class ParcelsService {
  ...
  async  createOrder(createOrderDto:CreateOrderDto) : Promise<Parcel>  {
  ...
  async acceptReject(acceptRejectParcelDto: AcceptRejectParcelDto){
    ...
    if(acceptRejectParcelDto.driverDecision === 'accept'){
      ...
      let packageID = acceptRejectParcelDto.packageID
      let orderDriverID = acceptingDriver.userId
      let orderOwnerID = parcelOwner.userId
      let orderType = parcel.packageType
      let orderPickupTime = ''
      let orderDriverDepartingCoordinates = {}
      let driverDepartingPickupDistance = {}
      let orderPickupCoordinates = {}
      let orderDeliveryCoordinates = {}
      let orderRouteDistance = ''
      let DeliveryStatus = ''
      let orderAmount = ''

      let newOrder  = {
        packageID: packageID,
        orderDriverID: orderDriverID,
        orderOwnerID: orderOwnerID,
        orderType: orderType,
        orderPickupTime: orderPickupTime,
        orderDriverDepartingCoordinates: orderDriverDepartingCoordinates,
        driverDepartingPickupDistance: driverDepartingPickupDistance,
        orderPickupCoordinates: orderPickupCoordinates,
        orderDeliveryCoordinates: orderDeliveryCoordinates,
        orderRouteDistance: orderRouteDistance,
