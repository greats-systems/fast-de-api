  ...
  async acceptReject(acceptRejectParcelDto: AcceptRejectParcelDto){
    ...
    if(acceptRejectParcelDto.driverDecision === 'accept'){
      ...
      if (Expo.isExpoPushToken(pushToken)) {
        ...
        let packagePickupDistance = driverDepartingPickupDistance(acceptRejectParcelDto.driverDepartingCoordinates)
        let newOrder  = {
          ...
          orderPickupDistance: packagePickupDistance,
          ...
          orderAmount: parcel.packageDeliveryFee,
        }
