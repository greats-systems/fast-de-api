...
export class ParcelsService {
  ...
  async acceptReject(acceptRejectParcelDto: AcceptRejectParcelDto){
    ...
    if(acceptRejectParcelDto.driverDecision === 'accept'){
      ...
      console.log('Got driver pushToken');
      console.log(pushToken);
      const acceptingDriver = await this.userService.findOneByPhone(acceptRejectParcelDto.driverPhone, 'driver')
      ...
      if (Expo.isExpoPushToken(pushToken)) {
        ...
        let newOrder  = {
          ...
          packageDeliveryFee: parcel.packageDeliveryFee,
          // from generated now
    ...
    if(acceptRejectParcelDto.driverDecision === 'reject'){
      const rejectingDriver = this.userService.findOneByPhone(acceptRejectParcelDto.driverPhone, 'driver')
