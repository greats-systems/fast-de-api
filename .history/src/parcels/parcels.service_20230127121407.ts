    ...
    if(acceptRejectParcelDto.driverDecision === 'accept'){
      ...
      if (Expo.isExpoPushToken(pushToken)) {
        ...
        let newOrder  = {
          ...
          orderDriverFirstName: parcel.packageDriverID,
          orderDriverLastName: parcel.packageDriverID,
          orderOwnerID: parcel.packageOwnerID,
          orderType: parcel.packageType,
          orderPickupTime: '2 PM',
          orderDriverDepartingCoordinates: '37.78825, 37.78825',
          driverDepartingPickupDistance: '37.78825, 37.78825',
          orderPickupCoordinates: '37.78825, 37.78825',
          orderDeliveryCoordinates: '37.78825, 37.78825',
          orderRouteDistance: '200M',
