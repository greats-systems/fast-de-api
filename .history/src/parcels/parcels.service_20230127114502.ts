...
export class ParcelsService {
  ...
  async acceptReject(acceptRejectParcelDto: AcceptRejectParcelDto){
    ...
    if(acceptRejectParcelDto.driverDecision === 'accept'){
      ...
      console.log('Got driver pushToken');
      console.log(pushToken);      packageID      orderDriverID      orderOwnerID      orderType      orderPickupTime      orderDriverDepartingCoordinates      driverDepartingPickupDistance      orderPickupCoordinates      orderDeliveryCoordinates      orderRouteDistance      DeliveryStatus      orderAmount
