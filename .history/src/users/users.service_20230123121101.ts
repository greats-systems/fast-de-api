...
export class UsersService {
  ...
  async create(createUserimport { CreateUserInput } from './dto/create-user.input';
: CreateMobileUserDTO): Promise<User> {
    const saltOrRounds = 10;
    const password = createUserimport { CreateUserInput } from './dto/create-user.input';
.password;
    createUserimport { CreateUserInput } from './dto/create-user.input';
.password = await bcrypt.hash(password, saltOrRounds);
    const userSchema = this.userRepository.create(createUserimport { CreateUserInput } from './dto/create-user.input';
);
  ...
  async loginUser(loginUserimport { CreateUserInput } from './dto/create-user.input';
: LoginUserimport { CreateUserInput } from './dto/create-user.input';
) {
