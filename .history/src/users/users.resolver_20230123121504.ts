...
export class UsersResolver {
  ...
  @Mutation(() => User)
  createUser(@Args('createMobileUserDTO') createMobileUserDTO: CreateMobileUserDTO) {
  ...
  loginUser(@Args('LoginMobileUserDTO') LoginMobileUserDTO: LoginMobileUserDTO) {
    return this.usersService.loginUser(LoginMobileUserDTO);
  }
}
